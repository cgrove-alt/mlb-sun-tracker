...
When the roof is open, loanDepot park has a southeast-facing orientation (135°), meaning home plate faces to the northwest and center field points to the southeast. This is a conventional orientation, and it creates the same shade patterns seen at most other SE-facing ballparks.

The sun tracks through Miami's southern sky and moves toward the southwest in the afternoon. Because the stadium faces southeast, the first base side of the park is shaded — away from the afternoon sun. First base sections are the clear shade choice when the roof is open.
...
When the roof is open, the first base side receives shade in the afternoon. The upper deck overhangs on the first base line block the south/southwest sun from reaching lower deck sections below. Sections in the lower bowl along the first base line typically enter shade by the third or fourth inning.
...
**Spring (March–May):** Miami temperatures are more moderate in spring, and the roof may be open more frequently. For afternoon games, first base side sections offer the best shade. Temperatures are generally manageable, but the sun can still be strong.
...
**Fall (September–October):** Similar to spring — temperatures moderate and the roof may open more often for afternoon games. First base side is your shade destination when the roof is up.
...
For games where the roof might be open or is undecided, bring sunscreen as a precaution and consider the first base side seating for shade protection.
