...
- **Still blocking diagrams:** the live path no longer emits `generateBaseballSections`
  ...
  (fail closed). Forty-three parks have source-backed inventories (Albuquerque
  ...
  Norfolk, Oklahoma City, Omaha [partial], Portland, Richmond, Rocket City,
  Round Rock [partial], Sacramento, Salem, Somerset, St. Paul, Toledo,
  Vancouver [partial], Worcester [partial]). The other 77 still need official
  chart IDs — do **not** fill them with a template.
