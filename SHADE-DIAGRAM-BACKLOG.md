...
- **Still blocking diagrams:** the live path no longer emits `generateBaseballSections`
  ...
  (fail closed). Twenty-seven parks have source-backed inventories (Buffalo,
  Birmingham, Charlotte, Columbus Clippers, Dayton, Durham, Erie, Frisco,
  Gwinnett, Indianapolis [partial], Iowa, Jacksonville, Las Vegas, Louisville,
  Memphis [partial], Montgomery, Nashville, New Hampshire [partial], Norfolk,
  Oklahoma City, Richmond, Rocket City, Salem, Somerset, St. Paul, Toledo,
  Worcester [partial]). The other 93 still need official chart IDs — do
  **not** fill them with a template.
