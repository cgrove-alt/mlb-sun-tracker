...
- **Still blocking diagrams:** the live path no longer emits `generateBaseballSections`
  ...
  (fail closed). Forty-two parks have source-backed inventories (Albuquerque
  ...
  Norfolk, Oklahoma City, Portland, Richmond, Rocket City, Round Rock
  [partial], Sacramento, Salem, Somerset, St. Paul, Toledo, Vancouver
  [partial], Worcester [partial]). The other 78 still need official chart IDs —
