...
- **Still blocking diagrams:** the live path no longer emits `generateBaseballSections`
  ...
  (fail closed). One hundred seven parks have source-backed inventories (Aberdeen, Akron,
  ...
  Daytona, Delmarva, Durham, Erie, Everett, Fayetteville, Fort Myers, Fort Wayne [partial],
  ...
  San Jose, Scranton/Wilkes-Barre, Somerset, South Bend, Springfield, St. Lucie, St. Paul,
  Stockton, Sugar Land, Syracuse, Tacoma [partial], Tampa, Toledo, Tulsa, Vancouver [partial],
  Visalia, Wichita, Wilmington, Winston-Salem [partial], Wisconsin, Worcester [partial]). The
  other 13 still need official chart IDs — do **not** fill them with a template.
