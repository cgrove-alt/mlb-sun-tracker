...
- **Still blocking diagrams:** the live path no longer emits `generateBaseballSections`
  ...
  (fail closed). Forty-five parks have source-backed inventories (Albuquerque
  ...
  [partial], Frisco, Greenville, Gwinnett, Harrisburg, Hartford, Indianapolis
  [partial], Iowa, Jacksonville, Las Vegas, Lehigh Valley, Louisville, Memphis
  [partial], Midland [partial], Montgomery, Nashville, New Hampshire [partial],
  Norfolk, Oklahoma City, Omaha [partial], Pensacola, Portland, Richmond,
  Rocket City, Round Rock [partial], Sacramento, Salem, Somerset, St. Paul,
  Syracuse, Toledo, Vancouver [partial], Worcester [partial]). The other 75
