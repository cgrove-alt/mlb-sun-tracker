...
- **Still blocking diagrams:** the live path no longer emits `generateBaseballSections`
  ...
  (fail closed). Forty-seven parks have source-backed inventories (Albuquerque
  ...
  Indianapolis [partial], Iowa, Jacksonville, Las Vegas, Lehigh Valley,
  Louisville, Memphis [partial], Midland [partial], Montgomery, Myrtle Beach,
  Nashville, New Hampshire [partial], Norfolk, Oklahoma City, Omaha [partial],
  Pensacola, Portland, Richmond, Rocket City, Round Rock [partial], Sacramento,
  Salem, Somerset, St. Paul, Syracuse, Toledo, Vancouver [partial], Worcester
  [partial]). The other 73 still need official chart IDs — do **not** fill them
  with a template.
