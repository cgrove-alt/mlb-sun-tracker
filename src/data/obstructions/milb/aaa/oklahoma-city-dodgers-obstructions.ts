// Chickasaw Bricktown Ballpark - 3D Obstruction Models
...
export const oklahomacitydodgersObstructions: Obstruction3D[] = [
  {
    id: 'upper_deck_home',
...
export default oklahomacitydodgersObstructions;
