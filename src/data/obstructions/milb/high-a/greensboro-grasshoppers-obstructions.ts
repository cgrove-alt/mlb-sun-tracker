// First National Bank Field - 3D Obstruction Models
...
export const greensborograsshoppersObstructions: Obstruction3D[] = [
  {
    id: 'scoreboard',
    name: 'Scoreboard',
    type: 'structure',
...
export default greensborograsshoppersObstructions;
