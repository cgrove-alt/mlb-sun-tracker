// Modern Woodmen Park - 3D Obstruction Models
...
export const quadcitiesriverbanditsObstructions: Obstruction3D[] = [
  {
    id: 'scoreboard',
    name: 'Scoreboard',
    type: 'structure',
...
export default quadcitiesriverbanditsObstructions;
