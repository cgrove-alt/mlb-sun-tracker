// Heritage Financial Park - 3D Obstruction Models
...
export const hudsonvalleyrenegadesObstructions: Obstruction3D[] = [
  {
    id: 'scoreboard',
    name: 'Scoreboard',
    type: 'structure',
...
export default hudsonvalleyrenegadesObstructions;
