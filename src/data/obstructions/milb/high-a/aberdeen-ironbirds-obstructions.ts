// Leidos Field at Ripken Stadium - 3D Obstruction Models
...
export const aberdeenironbirdsObstructions: Obstruction3D[] = [
  {
    id: 'scoreboard',
    name: 'Scoreboard',
    type: 'structure',
...
export default aberdeenironbirdsObstructions;
