// Daniel S. Frawley Stadium - 3D Obstruction Models
...
export const wilmingtonbluerocksObstructions: Obstruction3D[] = [
  {
    id: 'scoreboard',
    name: 'Scoreboard',
    type: 'structure',
...
export default wilmingtonbluerocksObstructions;
