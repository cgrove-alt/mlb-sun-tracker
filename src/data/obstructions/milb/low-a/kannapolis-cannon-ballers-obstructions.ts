// Atrium Health Ballpark - 3D Obstruction Models
...
export const kannapoliscannonballersObstructions: Obstruction3D[] = [
  {
    id: 'scoreboard',
    name: 'Scoreboard',
    type: 'structure',
...
export default kannapoliscannonballersObstructions;
