// Arvest Ballpark - 3D Obstruction Models
...
export const northwestarkansasnaturalsObstructions: Obstruction3D[] = [
  {
    id: 'upper_deck_home',
...
export default northwestarkansasnaturalsObstructions;
