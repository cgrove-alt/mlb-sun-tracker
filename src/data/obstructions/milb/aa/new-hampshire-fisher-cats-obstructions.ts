// Delta Dental Stadium - 3D Obstruction Models
...
export const newhampshirefishercatsObstructions: Obstruction3D[] = [
  {
    id: 'upper_deck_home',
...
export default newhampshirefishercatsObstructions;
