// Nelson W. Wolff Municipal Stadium - 3D Obstruction Models
...
export const sanantoniomissionsObstructions: Obstruction3D[] = [
  {
    id: 'upper_deck_home',
...
export default sanantoniomissionsObstructions;
