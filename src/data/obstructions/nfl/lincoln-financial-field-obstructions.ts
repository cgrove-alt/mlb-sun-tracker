// Lincoln Financial Field - 3D Obstruction Models
...
export const lincolnfinancialfieldObstructions: Obstruction3D[] = [
  {
    id: 'upper_deck_east',
...
export default lincolnfinancialfieldObstructions;
