// Bank of America Stadium - 3D Obstruction Models
...
export const bankofamericastadiumObstructions: Obstruction3D[] = [
  {
    id: 'upper_deck_east',
...
export default bankofamericastadiumObstructions;
