...
export const SOURCE_BACKED_INVENTORY_STADIUMS: ReadonlySet<string> = new Set([
  ...
  'asheville-tourists', 'albuquerque-isotopes',
  'birmingham-barons', 'bowling-green-hot-rods', 'brooklyn-cyclones',
  'buffalo-bisons', 'charlotte-knights', 'columbia-fireflies',
  ...
  'rocket-city-trash-pandas', 'round-rock-express', 'sacramento-river-cats',
  'salem-red-sox',
  'somerset-patriots',
