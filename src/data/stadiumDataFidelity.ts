...
export const SOURCE_BACKED_INVENTORY_STADIUMS: ReadonlySet<string> = new Set([
  ...
  'asheville-tourists', 'akron-rubberducks',
  ...
  'beloit-sky-carp',
  'biloxi-shuckers',
  'birmingham-barons', 'bowling-green-hot-rods', 'brooklyn-cyclones',
  'buffalo-bisons', 'charleston-riverdogs',
  'charlotte-knights', 'columbia-fireflies',
  'columbus-clippers',   'dayton-dragons',
  'delmarva-shorebirds',
  'durham-bulls', 'erie-seawolves',
  'jupiter-hammerheads',
  'lansing-lugnuts',
  'everett-aquasox',
  'cedar-rapids-kernels',
  'corpus-christi-hooks',
  'fort-myers-mighty-mussels', 'fort-wayne-tincaps', 'fredericksburg-nationals',
  'fresno-grizzlies',
  'frisco-roughriders',
  ...
  'lynchburg-hillcats',
  'memphis-redbirds', 'midland-rockhounds',
  'modesto-nuts',
  'montgomery-biscuits', 'nashville-sounds', 'new-hampshire-fisher-cats',
  'norfolk-tides', 'northwest-arkansas-naturals', 'oklahoma-city-dodgers', 'omaha-storm-chasers',
  'palm-beach-cardinals',
  'peoria-chiefs',
  'pensacola-blue-wahoos', 'portland-sea-dogs',
  'rancho-cucamonga-quakes',
  'reading-fightin-phils',
  'rochester-red-wings',
  'richmond-flying-squirrels',
  'rocket-city-trash-pandas', 'rome-braves',
  'round-rock-express', 'sacramento-river-cats',
  'salem-red-sox',
  'salt-lake-bees',
  'san-jose-giants',
  'scranton-railriders',
