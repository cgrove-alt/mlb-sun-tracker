...
// Generated from MLB Stats API on 2024
...
export const MILB_VENUE_TO_TEAM_MAP: Record<number, number> = {
  ...
  2843: 238,  // Chickasaw Bricktown Ballpark -> Oklahoma City Baseball Club
  3810: 431,  // Coolray Field -> Gwinnett Stripers
  2772: 561,  // Smith's Ballpark -> Salt Lake Bees
  2852: 564,  // 121 Financial Ballpark -> Jacksonville Jumbo Shrimp
  ...
  2779: 546,  // Hadlock Field -> Portland Sea Dogs
  2861: 482,  // Whataburger Field -> Corpus Christi Hooks
  2832: 418,  // Prince George's Stadium -> Bowie Baysox
  ...
  5450: 3898,  // Riverfront Stadium -> Wichita Wind Surge
  ...
  4429: 419,  // Ron Tonkin Field -> Hillsboro Hops
  2730: 486,  // Avista Stadium -> Spokane Indians
  2850: 550,  // Four Winds Field -> South Bend Cubs
  2837: 488,  // Leidos Field at Ripken Stadium -> Aberdeen IronBirds
  ...
  2857: 492,  // Rise 2 Greatness Field -> Cedar Rapids Kernels
  ...
  2523: 587,  // George M. Steinbrenner Field -> Tampa Tarpons
  ...
  2520: 279,  // Roger Dean Chevrolet Stadium -> Palm Beach Cardinals
  ...
  // 2520: 479,  // Roger Dean Chevrolet Stadium -> Jupiter Hammerheads (duplicate venue)
  2803: 481,  // Bank of the James Stadium -> Lynchburg Hillcats
  2729: 548,  // Arthur W. Perdue Stadium -> Delmarva Shorebirds
  2777: 485,  // Grainger Stadium -> Down East Wood Ducks
