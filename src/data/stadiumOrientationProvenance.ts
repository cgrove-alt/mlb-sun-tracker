...
export const MLB_ORIENTATION_PROVENANCE: OrientationProvenance[] = [
  ...
  { stadiumId: 'marlins',      orientation: 129.036, confidence: 'verified', precisionDeg: 1, method: 'gis-measured', sources: ['Miami-Dade County 2021 Woolpert orthophoto ImageServer, primary raster OBJECTID 7221, ground condition 2021-01-23: https://imageserverintra.miamidade.gov/arcgis/rest/services/WGS1984_WebMercator/2021_Woolpert_WGS1984_WebMercator/ImageServer', 'Deterministic reviewed measurement artifact tmp/lidar/marlins-2021-infield-orientation-v1.json, artifact sha256:cdf33ff549e7715dc37ceedea4b3f427559f67b39c8c2437d6ba7f561e168d63: opposite infield-edge holdout disagreement 0.692°, conservative combined uncertainty 0.815°', '2026 Official Baseball Rules, Rule 2.01: https://mktg.mlbstatic.com/mlb/official-information/2026-official-baseball-rules.pdf', 'Published southeast-orientation descriptions independently corroborate the measured ESE quadrant'], notes: 'GIS measurement replaces the coarse 135° estimate with 129.036°. The official open-roof orthophoto exposes the infield. Disjoint top-left and bottom-right grass-to-dirt edge pairs yield 129.301° and 128.609°; their opposite-corner diagonal yields 129.199°; the mound center is 1.484 pixels from that diagonal. Bright L-shaped field objects were explicitly rejected as non-foul-line cues. This clears the orientation uncertainty gate only. Absolute horizontal accuracy, vertical geometry, obstructions, and shadow holdouts remain blocked.', lastReviewed: '2026-08-09' },
  ...
  { stadiumId: 'rays',         orientation: 316, confidence: 'verified',   precisionDeg: 12, method: 'published-source', sources: ['ballparks.com: Tropicana Field diamond orientation', 'roof:fixed — Tropicana Field is a fixed-roof dome; orientation is nominal and does not affect shade'], notes: 'Updated 2026-07-20: Rays returned to Tropicana Field (fixed-roof DOME) for 2026 — orientation is nominal (316°) and NOT applicable to shade (every seat is roofed). The prior 60° value reflected Steinbrenner Field, the 2025 temporary home, which is now only the Tampa Tarpons (MiLB) venue.', lastReviewed: '2026-07-20' },
