...
export const MLB_ORIENTATION_PROVENANCE: OrientationProvenance[] = [
  ...
  { stadiumId: 'bluejays',     orientation: 15,  confidence: 'unverified', notes: 'Retractable roof was closed in 2026-05-13 imagery (Esri); field not visible from above. OSM Rogers Centre building outline (way 7969701) PCA principal axis: 354.3° N (aspect 1.18× — moderate). OSM pitch polygon (way 54223820) PCA: 265.8° (aspect 1.22×) — these disagree by ~90° which is typical when the OSM pitch was drawn rotated relative to the building. Wikipedia notes CN Tower is at the base of the stadium (geographically NE of Rogers Centre center per coordinates) but doesn\'t state field orientation. Existing 15° NNE is within range of OSM building axis (354°) by ~20°; not enough to verify or refute. Needs interactive measurement.' },
  ...
  { stadiumId: 'brewers',      orientation: 357, confidence: 'unverified', notes: 'American Family Field retractable roof was partially open in 2026-05-13 imagery — a fan-shaped roof segment was retracted revealing part of the infield, but the angle of view made HP/CF identification uncertain. OSM pitch polygon PCA gave 312°/132° (aspect 1.18×); OSM stadium building PCA 105°/285° (aspect 1.09×, basically square). Both OSM signals are weak. Current 357° N is plausible but not confirmed. Needs interactive measurement.' },
  ...
  { stadiumId: 'diamondbacks', orientation: 23,  confidence: 'unverified', notes: 'Chase Field retractable roof was fully closed in 2026-05-13 imagery; field not visible from above. OSM building outline (way 24635438) PCA gave 85°/265° (aspect 1.29×) — the building is somewhat elongated E-W, but the building axis can differ from the field axis for asymmetric stadiums. No Wikipedia source found with explicit orientation. Current 23° NNE is plausible but unconfirmed. Needs interactive measurement.' },
