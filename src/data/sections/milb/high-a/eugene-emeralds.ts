// PK Park - Comprehensive Section Data
...
export const eugeneemeraldsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const eugeneemeraldsSectionMap = new Map(
  eugeneemeraldsSections.map(section => [section.id, section])
);
