// Daniel S. Frawley Stadium - Comprehensive Section Data
...
export const wilmingtonbluerocksSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const wilmingtonbluerocksSectionMap = new Map(
  wilmingtonbluerocksSections.map(section => [section.id, section])
);
