// AdventHealth Stadium - Comprehensive Section Data
...
export const romebravesSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const romebravesSectionMap = new Map(
  romebravesSections.map(section => [section.id, section])
);
