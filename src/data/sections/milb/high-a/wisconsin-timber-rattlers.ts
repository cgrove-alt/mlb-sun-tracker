// Neuroscience Group Field at Fox Cities Stadium - Comprehensive Section Data
...
export const wisconsintimberrattlersSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const wisconsintimberrattlersSectionMap = new Map(
  wisconsintimberrattlersSections.map(section => [section.id, section])
);
