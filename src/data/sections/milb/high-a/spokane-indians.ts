// Avista Stadium - Comprehensive Section Data
...
export const spokaneindiansSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const spokaneindiansSectionMap = new Map(
  spokaneindiansSections.map(section => [section.id, section])
);
