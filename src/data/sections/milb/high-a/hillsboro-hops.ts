// Ron Tonkin Field - Comprehensive Section Data
...
export const hillsborohopsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const hillsborohopsSectionMap = new Map(
  hillsborohopsSections.map(section => [section.id, section])
);
