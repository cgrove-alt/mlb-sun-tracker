// Fluor Field at the West End - Comprehensive Section Data
...
export const greenvilledriveSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const greenvilledriveSectionMap = new Map(
  greenvilledriveSections.map(section => [section.id, section])
);
