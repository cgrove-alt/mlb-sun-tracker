// Gesa Stadium - Comprehensive Section Data
...
export const tricitydustdevilsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const tricitydustdevilsSectionMap = new Map(
  tricitydustdevilsSections.map(section => [section.id, section])
);
