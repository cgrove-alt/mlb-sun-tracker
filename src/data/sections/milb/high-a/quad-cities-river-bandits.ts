// Modern Woodmen Park - Comprehensive Section Data
...
export const quadcitiesriverbanditsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const quadcitiesriverbanditsSectionMap = new Map(
  quadcitiesriverbanditsSections.map(section => [section.id, section])
);
