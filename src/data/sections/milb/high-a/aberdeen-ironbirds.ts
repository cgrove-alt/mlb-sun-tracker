// Leidos Field at Ripken Stadium - Comprehensive Section Data
...
export const aberdeenironbirdsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const aberdeenironbirdsSectionMap = new Map(
  aberdeenironbirdsSections.map(section => [section.id, section])
);
