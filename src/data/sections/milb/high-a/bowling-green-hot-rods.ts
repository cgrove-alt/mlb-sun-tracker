// Bowling Green Ballpark - Comprehensive Section Data
...
export const bowlinggreenhotrodsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const bowlinggreenhotrodsSectionMap = new Map(
  bowlinggreenhotrodsSections.map(section => [section.id, section])
);
