// Nat Bailey Stadium - Comprehensive Section Data
...
export const vancouvercanadiansSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const vancouvercanadiansSectionMap = new Map(
  vancouvercanadiansSections.map(section => [section.id, section])
);
