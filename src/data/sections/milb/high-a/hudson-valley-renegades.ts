// Heritage Financial Park - Comprehensive Section Data
...
export const hudsonvalleyrenegadesSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const hudsonvalleyrenegadesSectionMap = new Map(
  hudsonvalleyrenegadesSections.map(section => [section.id, section])
);
