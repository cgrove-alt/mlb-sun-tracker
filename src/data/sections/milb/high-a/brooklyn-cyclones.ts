// Maimonides Park - Comprehensive Section Data
...
export const brooklyncyclonesSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const brooklyncyclonesSectionMap = new Map(
  brooklyncyclonesSections.map(section => [section.id, section])
);
