// Four Winds Field - Comprehensive Section Data
...
export const southbendcubsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const southbendcubsSectionMap = new Map(
  southbendcubsSections.map(section => [section.id, section])
);
