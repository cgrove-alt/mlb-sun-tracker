// First National Bank Field - Comprehensive Section Data
...
export const greensborograsshoppersSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const greensborograsshoppersSectionMap = new Map(
  greensborograsshoppersSections.map(section => [section.id, section])
);
