// Funko Field - Comprehensive Section Data
...
export const everettaquasoxSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const everettaquasoxSectionMap = new Map(
  everettaquasoxSections.map(section => [section.id, section])
);
