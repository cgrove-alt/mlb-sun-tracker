// ABC Supply Stadium - Comprehensive Section Data
...
export const beloitskycarpSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const beloitskycarpSectionMap = new Map(
  beloitskycarpSections.map(section => [section.id, section])
);
