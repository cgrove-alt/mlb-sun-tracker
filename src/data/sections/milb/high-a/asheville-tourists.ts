// McCormick Field - Comprehensive Section Data
...
export const ashevilletouristsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const ashevilletouristsSectionMap = new Map(
  ashevilletouristsSections.map(section => [section.id, section])
);
