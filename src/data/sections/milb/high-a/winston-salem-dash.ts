// Truist Stadium - Comprehensive Section Data
...
export const winstonsalemdashSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const winstonsalemdashSectionMap = new Map(
  winstonsalemdashSections.map(section => [section.id, section])
);
