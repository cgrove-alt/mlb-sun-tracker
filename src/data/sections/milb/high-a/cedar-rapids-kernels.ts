// Veterans Memorial Stadium - Comprehensive Section Data
...
export const cedarrapidskernelsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const cedarrapidskernelsSectionMap = new Map(
  cedarrapidskernelsSections.map(section => [section.id, section])
);
