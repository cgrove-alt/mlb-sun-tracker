// Parkview Field - Comprehensive Section Data
...
export const fortwaynetincapsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const fortwaynetincapsSectionMap = new Map(
  fortwaynetincapsSections.map(section => [section.id, section])
);
