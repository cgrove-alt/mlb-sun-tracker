// L.P. Frans Stadium - Comprehensive Section Data
...
export const hickorycrawdadsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const hickorycrawdadsSectionMap = new Map(
  hickorycrawdadsSections.map(section => [section.id, section])
);
