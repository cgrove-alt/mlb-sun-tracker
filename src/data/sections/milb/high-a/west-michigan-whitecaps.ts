// LMCU Ballpark - Comprehensive Section Data
...
export const westmichiganwhitecapsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const westmichiganwhitecapsSectionMap = new Map(
  westmichiganwhitecapsSections.map(section => [section.id, section])
);
