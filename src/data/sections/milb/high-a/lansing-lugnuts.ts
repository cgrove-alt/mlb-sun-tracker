// Jackson Field - Comprehensive Section Data
...
export const lansinglugnutsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const lansinglugnutsSectionMap = new Map(
  lansinglugnutsSections.map(section => [section.id, section])
);
