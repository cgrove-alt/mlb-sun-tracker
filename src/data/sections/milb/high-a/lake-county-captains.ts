// Classic Park - Comprehensive Section Data
...
export const lakecountycaptainsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const lakecountycaptainsSectionMap = new Map(
  lakecountycaptainsSections.map(section => [section.id, section])
);
