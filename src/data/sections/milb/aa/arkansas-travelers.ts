// Dickey-Stephens Park - Comprehensive Section Data
...
export const arkansastravelersSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const arkansastravelersSectionMap = new Map(
  arkansastravelersSections.map(section => [section.id, section])
);
