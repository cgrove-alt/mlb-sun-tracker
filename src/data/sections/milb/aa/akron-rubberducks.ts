// Canal Park - Comprehensive Section Data
...
export const akronrubberducksSectionMap = new Map(
  akronrubberducksSections.map(section => [section.id, section])
);
