// TD Bank Ballpark - Comprehensive Section Data
...
export const somersetpatriotsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const somersetpatriotsSectionMap = new Map(
  somersetpatriotsSections.map(section => [section.id, section])
);
