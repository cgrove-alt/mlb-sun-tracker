// Prince George's Stadium - Comprehensive Section Data
...
export const bowiebaysoxSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const bowiebaysoxSectionMap = new Map(
  bowiebaysoxSections.map(section => [section.id, section])
);
