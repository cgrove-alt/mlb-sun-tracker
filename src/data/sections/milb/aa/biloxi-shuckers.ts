// MGM Park - Comprehensive Section Data
...
export const biloxishuckersSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const biloxishuckersSectionMap = new Map(
  biloxishuckersSections.map(section => [section.id, section])
);
