// FNB Field - Comprehensive Section Data
...
export const harrisburgsenatorsSectionMap = new Map(
  harrisburgsenatorsSections.map(section => [section.id, section])
);
