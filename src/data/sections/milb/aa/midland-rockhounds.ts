// Momentum Bank Ballpark - Comprehensive Section Data
...
export const midlandrockhoundsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const midlandrockhoundsSectionMap = new Map(
  midlandrockhoundsSections.map(section => [section.id, section])
);
