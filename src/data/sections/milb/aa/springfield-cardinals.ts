// Hammons Field - Comprehensive Section Data
...
export const springfieldcardinalsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const springfieldcardinalsSectionMap = new Map(
  springfieldcardinalsSections.map(section => [section.id, section])
);
