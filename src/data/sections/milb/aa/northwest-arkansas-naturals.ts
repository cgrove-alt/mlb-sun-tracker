// Arvest Ballpark - Comprehensive Section Data
...
export const northwestarkansasnaturalsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const northwestarkansasnaturalsSectionMap = new Map(
  northwestarkansasnaturalsSections.map(section => [section.id, section])
);
