// ONEOK Field - Comprehensive Section Data
...
export const tulsadrillersSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const tulsadrillersSectionMap = new Map(
  tulsadrillersSections.map(section => [section.id, section])
);
