// Riverwalk Stadium - Comprehensive Section Data
...
export const montgomerybiscuitsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const montgomerybiscuitsSectionMap = new Map(
  montgomerybiscuitsSections.map(section => [section.id, section])
);
