// Hadlock Field - Comprehensive Section Data
...
export const portlandseadogsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const portlandseadogsSectionMap = new Map(
  portlandseadogsSections.map(section => [section.id, section])
);
