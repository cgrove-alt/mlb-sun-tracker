// Toyota Field - Comprehensive Section Data
...
export const rocketcitytrashpandasSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const rocketcitytrashpandasSectionMap = new Map(
  rocketcitytrashpandasSections.map(section => [section.id, section])
);
