// Delta Dental Stadium - Comprehensive Section Data
...
export const newhampshirefishercatsSectionMap = new Map(
  newhampshirefishercatsSections.map(section => [section.id, section])
);
