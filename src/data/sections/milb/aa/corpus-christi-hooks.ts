// Whataburger Field - Comprehensive Section Data
...
export const corpuschristihooksSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const corpuschristihooksSectionMap = new Map(
  corpuschristihooksSections.map(section => [section.id, section])
);
