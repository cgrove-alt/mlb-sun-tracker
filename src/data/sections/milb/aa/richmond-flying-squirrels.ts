// The Diamond - Comprehensive Section Data
...
export const richmondflyingsquirrelsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const richmondflyingsquirrelsSectionMap = new Map(
  richmondflyingsquirrelsSections.map(section => [section.id, section])
);
