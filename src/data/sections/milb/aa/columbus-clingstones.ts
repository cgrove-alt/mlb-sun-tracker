// Synovus Park - Comprehensive Section Data
...
export const columbusclingstonesSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const columbusclingstonesSectionMap = new Map(
  columbusclingstonesSections.map(section => [section.id, section])
);
