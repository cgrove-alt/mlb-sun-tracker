// Regions Field - Comprehensive Section Data
...
export const birminghambaronsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const birminghambaronsSectionMap = new Map(
  birminghambaronsSections.map(section => [section.id, section])
);
