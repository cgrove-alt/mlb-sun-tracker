// Riders Field - Comprehensive Section Data
...
export const friscoroughridersSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const friscoroughridersSectionMap = new Map(
  friscoroughridersSections.map(section => [section.id, section])
);
