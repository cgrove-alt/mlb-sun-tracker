// Blue Wahoos Stadium - Comprehensive Section Data
...
export const pensacolabluewahoosSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const pensacolabluewahoosSectionMap = new Map(
  pensacolabluewahoosSections.map(section => [section.id, section])
);
