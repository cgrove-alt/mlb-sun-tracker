// Clover Park - Comprehensive Section Data
...
export const stluciemetsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const stluciemetsSectionMap = new Map(
  stluciemetsSections.map(section => [section.id, section])
);
