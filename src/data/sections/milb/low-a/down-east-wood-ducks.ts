// Grainger Stadium - Comprehensive Section Data
...
export const downeastwoodducksSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const downeastwoodducksSectionMap = new Map(
  downeastwoodducksSections.map(section => [section.id, section])
);
