// Carilion Clinic Field at Salem Memorial Ballpark - Comprehensive Section Data
...
export const salemredsoxSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const salemredsoxSectionMap = new Map(
  salemredsoxSections.map(section => [section.id, section])
);
