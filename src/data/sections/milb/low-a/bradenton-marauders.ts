// LECOM Park - Comprehensive Section Data
...
export const bradentonmaraudersSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const bradentonmaraudersSectionMap = new Map(
  bradentonmaraudersSections.map(section => [section.id, section])
);
