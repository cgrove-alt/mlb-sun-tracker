// Lake Elsinore Diamond - Comprehensive Section Data
...
export const lakeelsinorestormSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const lakeelsinorestormSectionMap = new Map(
  lakeelsinorestormSections.map(section => [section.id, section])
);
