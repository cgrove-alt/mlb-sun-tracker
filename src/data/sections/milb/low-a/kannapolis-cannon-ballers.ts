// Atrium Health Ballpark - Comprehensive Section Data
...
export const kannapoliscannonballersSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const kannapoliscannonballersSectionMap = new Map(
  kannapoliscannonballersSections.map(section => [section.id, section])
);
