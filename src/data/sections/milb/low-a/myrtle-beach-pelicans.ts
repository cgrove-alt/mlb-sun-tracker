// Pelicans Ballpark - Comprehensive Section Data
...
export const myrtlebeachpelicansSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const myrtlebeachpelicansSectionMap = new Map(
  myrtlebeachpelicansSections.map(section => [section.id, section])
);
