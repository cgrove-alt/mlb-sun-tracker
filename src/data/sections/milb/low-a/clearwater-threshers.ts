// BayCare Ballpark - Comprehensive Section Data
...
export const clearwaterthreshersSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const clearwaterthreshersSectionMap = new Map(
  clearwaterthreshersSections.map(section => [section.id, section])
);
