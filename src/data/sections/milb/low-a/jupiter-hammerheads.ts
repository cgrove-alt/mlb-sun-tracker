...
export const jupiterhammerheadsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const jupiterhammerheadsSectionMap = new Map(
  jupiterhammerheadsSections.map(section => [section.id, section])
);
