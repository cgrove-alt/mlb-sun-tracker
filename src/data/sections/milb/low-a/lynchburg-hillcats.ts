// Bank of the James Stadium - Comprehensive Section Data
...
export const lynchburghillcatsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const lynchburghillcatsSectionMap = new Map(
  lynchburghillcatsSections.map(section => [section.id, section])
);
