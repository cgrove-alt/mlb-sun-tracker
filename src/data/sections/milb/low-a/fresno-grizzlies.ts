// Chukchansi Park - Comprehensive Section Data
...
export const fresnogrizzliesSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const fresnogrizzliesSectionMap = new Map(
  fresnogrizzliesSections.map(section => [section.id, section])
);
