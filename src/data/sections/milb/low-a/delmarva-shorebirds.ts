// Arthur W. Perdue Stadium - Comprehensive Section Data
...
export const delmarvashorebirdsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const delmarvashorebirdsSectionMap = new Map(
  delmarvashorebirdsSections.map(section => [section.id, section])
);
