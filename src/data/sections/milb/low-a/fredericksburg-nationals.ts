// Virginia Credit Union Stadium - Comprehensive Section Data
...
export const fredericksburgnationalsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const fredericksburgnationalsSectionMap = new Map(
  fredericksburgnationalsSections.map(section => [section.id, section])
);
