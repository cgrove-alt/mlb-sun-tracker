// Excite Ballpark - Comprehensive Section Data
...
export const sanjosegiantsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const sanjosegiantsSectionMap = new Map(
  sanjosegiantsSections.map(section => [section.id, section])
);
