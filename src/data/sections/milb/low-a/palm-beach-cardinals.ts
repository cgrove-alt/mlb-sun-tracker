// Roger Dean Chevrolet Stadium - Comprehensive Section Data
...
export const palmbeachcardinalsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const palmbeachcardinalsSectionMap = new Map(
  palmbeachcardinalsSections.map(section => [section.id, section])
);
