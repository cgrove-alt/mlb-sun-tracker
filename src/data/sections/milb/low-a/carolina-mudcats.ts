// Five County Stadium - Comprehensive Section Data
...
export const carolinamudcatsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const carolinamudcatsSectionMap = new Map(
  carolinamudcatsSections.map(section => [section.id, section])
);
