// SRP Park - Comprehensive Section Data
...
export const augustagreenjacketsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const augustagreenjacketsSectionMap = new Map(
  augustagreenjacketsSections.map(section => [section.id, section])
);
