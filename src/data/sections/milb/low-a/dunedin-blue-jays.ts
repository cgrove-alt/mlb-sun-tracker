// TD Ballpark - Comprehensive Section Data
...
export const dunedinbluejaysSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const dunedinbluejaysSectionMap = new Map(
  dunedinbluejaysSections.map(section => [section.id, section])
);
