// Joseph P. Riley Jr. Park - Comprehensive Section Data
...
export const charlestonriverdogsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const charlestonriverdogsSectionMap = new Map(
  charlestonriverdogsSections.map(section => [section.id, section])
);
