// Valley Strong Ballpark - Comprehensive Section Data
...
export const visaliarawhideSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const visaliarawhideSectionMap = new Map(
  visaliarawhideSections.map(section => [section.id, section])
);
