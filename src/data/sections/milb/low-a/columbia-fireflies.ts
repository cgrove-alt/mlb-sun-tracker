// Segra Park - Comprehensive Section Data
...
export const columbiafirefliesSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const columbiafirefliesSectionMap = new Map(
  columbiafirefliesSections.map(section => [section.id, section])
);
