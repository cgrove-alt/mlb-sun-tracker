// Segra Stadium - Comprehensive Section Data
...
export const fayettevillewoodpeckersSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const fayettevillewoodpeckersSectionMap = new Map(
  fayettevillewoodpeckersSections.map(section => [section.id, section])
);
