// San Manuel Stadium - Comprehensive Section Data
...
export const inlandempire66ersSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const inlandempire66ersSectionMap = new Map(
  inlandempire66ersSections.map(section => [section.id, section])
);
