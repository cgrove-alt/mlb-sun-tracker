// Publix Field at Joker Marchant Stadium - Comprehensive Section Data
...
export const lakelandflyingtigersSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const lakelandflyingtigersSectionMap = new Map(
  lakelandflyingtigersSections.map(section => [section.id, section])
);
