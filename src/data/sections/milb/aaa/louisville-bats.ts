// Louisville Slugger Field - Comprehensive Section Data
...
export const louisvillebatsSectionMap = new Map(
  louisvillebatsSections.map(section => [section.id, section])
);
