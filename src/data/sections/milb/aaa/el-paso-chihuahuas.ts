// Southwest University Park - Comprehensive Section Data
...
export const elpasochihuahuasSectionMap = new Map(
  elpasochihuahuasSections.map(section => [section.id, section])
);
