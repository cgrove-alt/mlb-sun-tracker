// Principal Park - Comprehensive Section Data
...
export const iowacubsSectionMap = new Map(
  iowacubsSections.map(section => [section.id, section])
);
