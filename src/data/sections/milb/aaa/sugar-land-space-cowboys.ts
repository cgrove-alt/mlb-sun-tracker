// Constellation Field - Comprehensive Section Data
...
export const sugarlandspacecowboysSectionMap = new Map(
  sugarlandspacecowboysSections.map(section => [section.id, section])
);
