...
export const lasvegasaviatorsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const lasvegasaviatorsSectionMap = new Map(
  lasvegasaviatorsSections.map(section => [section.id, section])
);
