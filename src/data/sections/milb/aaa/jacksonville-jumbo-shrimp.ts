// VyStar Ballpark - Comprehensive Section Data
...
export const jacksonvillejumboshrimpSectionMap = new Map(
  jacksonvillejumboshrimpSections.map(section => [section.id, section])
);
