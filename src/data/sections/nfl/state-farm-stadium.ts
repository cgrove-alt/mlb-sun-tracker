// State Farm Stadium - Comprehensive Section Data
...
export const statefarmstadiumSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const statefarmstadiumSectionMap = new Map(
  statefarmstadiumSections.map(section => [section.id, section])
);
