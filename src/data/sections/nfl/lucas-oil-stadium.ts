// Lucas Oil Stadium - Comprehensive Section Data
...
export const lucasoilstadiumSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const lucasoilstadiumSectionMap = new Map(
  lucasoilstadiumSections.map(section => [section.id, section])
);
