...
export const sofistadiumramsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const sofistadiumramsSectionMap = new Map(
  sofistadiumramsSections.map(section => [section.id, section])
);
