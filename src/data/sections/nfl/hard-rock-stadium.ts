// Hard Rock Stadium - Comprehensive Section Data
...
export const hardrockstadiumSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const hardrockstadiumSectionMap = new Map(
  hardrockstadiumSections.map(section => [section.id, section])
);
