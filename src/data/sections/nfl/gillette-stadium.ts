// Gillette Stadium - Comprehensive Section Data
...
export const gillettestadiumSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const gillettestadiumSectionMap = new Map(
  gillettestadiumSections.map(section => [section.id, section])
);
