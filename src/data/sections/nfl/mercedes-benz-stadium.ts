// Mercedes-Benz Stadium - Comprehensive Section Data
...
export const mercedesbenzstadiumSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const mercedesbenzstadiumSectionMap = new Map(
  mercedesbenzstadiumSections.map(section => [section.id, section])
);
