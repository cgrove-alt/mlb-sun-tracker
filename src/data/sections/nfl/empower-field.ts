// Empower Field at Mile High - Comprehensive Section Data
...
export const empowerfieldSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const empowerfieldSectionMap = new Map(
  empowerfieldSections.map(section => [section.id, section])
);
