// SoFi Stadium - Comprehensive Section Data
...
export const sofistadiumchargersSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const sofistadiumchargersSectionMap = new Map(
  sofistadiumchargersSections.map(section => [section.id, section])
);
