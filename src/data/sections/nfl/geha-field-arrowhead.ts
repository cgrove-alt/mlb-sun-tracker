// GEHA Field at Arrowhead Stadium - Comprehensive Section Data
...
export const gehafieldarrowheadSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const gehafieldarrowheadSectionMap = new Map(
  gehafieldarrowheadSections.map(section => [section.id, section])
);
