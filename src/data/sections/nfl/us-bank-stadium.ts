// U.S. Bank Stadium - Comprehensive Section Data
...
export const usbankstadiumSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const usbankstadiumSectionMap = new Map(
  usbankstadiumSections.map(section => [section.id, section])
);
