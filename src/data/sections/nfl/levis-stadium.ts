// Levi's Stadium - Comprehensive Section Data
...
export const levisstadiumSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const levisstadiumSectionMap = new Map(
  levisstadiumSections.map(section => [section.id, section])
);
