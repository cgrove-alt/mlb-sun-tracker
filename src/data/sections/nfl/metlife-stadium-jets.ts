...
export const metlifestadiumjetsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const metlifestadiumjetsSectionMap = new Map(
  metlifestadiumjetsSections.map(section => [section.id, section])
);
