// MetLife Stadium - Comprehensive Section Data
...
export const metlifestadiumgiantsSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const metlifestadiumgiantsSectionMap = new Map(
  metlifestadiumgiantsSections.map(section => [section.id, section])
);
