...
function generateRows(
  ...
  rake: number,
  covered: boolean = true // SoFi has translucent roof
): RowDetail[] {
...
export const sofiStadiumSections: DetailedSection[] = [
...
export const sofiStadiumCapacity = sofiStadiumSections.reduce((total, section) => {
...
export const sofiStadiumSectionMap = new Map(
  sofiStadiumSections.map(section => [section.id, section])
);

// Stadium-specific features
export const sofiStadiumFeatures = {
  etfeRoof: {
