// Allegiant Stadium - Comprehensive Section Data
...
export const allegiantstadiumSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const allegiantstadiumSectionMap = new Map(
  allegiantstadiumSections.map(section => [section.id, section])
);
