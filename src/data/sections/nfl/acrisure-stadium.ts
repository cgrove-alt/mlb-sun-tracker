// Acrisure Stadium - Comprehensive Section Data
...
export const acrisurestadiumSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const acrisurestadiumSectionMap = new Map(
  acrisurestadiumSections.map(section => [section.id, section])
);
