// Soldier Field - Comprehensive Section Data
...
export const soldierfieldSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const soldierfieldSectionMap = new Map(
  soldierfieldSections.map(section => [section.id, section])
);
