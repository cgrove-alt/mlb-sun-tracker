// Lumen Field - Comprehensive Section Data
...
export const lumenfieldSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const lumenfieldSectionMap = new Map(
  lumenfieldSections.map(section => [section.id, section])
);
