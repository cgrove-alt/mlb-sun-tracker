// M&T Bank Stadium - Comprehensive Section Data
...
export const mtbankstadiumSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const mtbankstadiumSectionMap = new Map(
  mtbankstadiumSections.map(section => [section.id, section])
);
