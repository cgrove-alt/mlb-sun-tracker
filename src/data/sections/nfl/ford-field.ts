// Ford Field - Comprehensive Section Data
...
export const fordfieldSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const fordfieldSectionMap = new Map(
  fordfieldSections.map(section => [section.id, section])
);
