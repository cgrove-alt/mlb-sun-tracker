// Raymond James Stadium - Comprehensive Section Data
...
export const raymondjamesstadiumSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const raymondjamesstadiumSectionMap = new Map(
  raymondjamesstadiumSections.map(section => [section.id, section])
);
