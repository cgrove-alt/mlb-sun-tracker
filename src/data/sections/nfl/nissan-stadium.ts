// Nissan Stadium - Comprehensive Section Data
...
export const nissanstadiumSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const nissanstadiumSectionMap = new Map(
  nissanstadiumSections.map(section => [section.id, section])
);
