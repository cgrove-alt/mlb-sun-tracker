// NRG Stadium - Comprehensive Section Data
...
export const nrgstadiumSections: DetailedSection[] = [
  {
    id: '100',
    name: 'Field 100',
    level: 'field',
...
export const nrgstadiumSectionMap = new Map(
  nrgstadiumSections.map(section => [section.id, section])
);
