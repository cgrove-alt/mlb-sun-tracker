...
export const tMobileParkSections: DetailedSection[] = [
  ...
  // The 'Pen (Left-Center Field)
  {
    ...
    rows: [
      { rowNumber: 'Patio', seats: 190, elevation: 25, depth: 0, covered: true }
    ],
    vertices: [
      { x: -100, y: 25, z: 350 },
      { x: -60, y: 25, z: 370 },
  ...
  // Edgar's Cantina (Left Field)
  {
    ...
    rows: [
      { rowNumber: 'Bar', seats: 150, elevation: 30, depth: 0, covered: true }
    ],
    vertices: [
      { x: -120, y: 30, z: 320 },
      { x: -90, y: 30, z: 340 },
  ...
  // Hit It Here Cafe (Right Field)
  {
    ...
    rows: [
      { rowNumber: 'Tables', seats: 100, elevation: 35, depth: 0, covered: true }
    ],
    vertices: [
      { x: 120, y: 35, z: 320 },
      { x: 150, y: 35, z: 340 },
  ...
  // Center Field Landing
  {
    ...
    rows: [
      { rowNumber: 'SRO', seats: 200, elevation: 35, depth: 0, covered: true }
    ],
    vertices: [
      { x: -25, y: 35, z: 400 },
      { x: 25, y: 35, z: 400 },
  ...
  // Lookout Landing (Center Field Bar)
  {
    ...
    orientation: 'center-field',
    rows: [
      { rowNumber: 'Bar', seats: 120, elevation: 40, depth: 0, covered: true }
    ],
    vertices: [
      { x: -40, y: 40, z: 390 },
      { x: 40, y: 40, z: 390 },
  ...
  // Northwest Gate Social Deck
  {
    ...
    orientation: 'left-center',
    rows: [
      { rowNumber: 'Deck', seats: 100, elevation: 30, depth: 0, covered: true }
    ],
    vertices: [
      { x: -80, y: 30, z: 365 },
      { x: -50, y: 30, z: 380 },
  ...
  // Protime Sports Grill
  {
    ...
    rows: [
      { rowNumber: 'Tables', seats: 80, elevation: 45, depth: 0, covered: true }
    ],
    vertices: [
      { x: 80, y: 45, z: 360 },
      { x: 110, y: 45, z: 375 },
