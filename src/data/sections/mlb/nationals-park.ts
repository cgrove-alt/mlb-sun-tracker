...
export const nationalsParkSections: DetailedSection[] = [
  ...
  // Scoreboard Walk
  {
    ...
    rows: [
      { rowNumber: 'SRO', seats: 300, elevation: 15, depth: 0, covered: false }
    ],
    vertices: [
      { x: 120, y: 15, z: 280 },
      { x: 150, y: 15, z: 320 },
  ...
  // Red Loft
  {
    ...
    orientation: 'center-field',
    rows: [
      { rowNumber: 'Loft', seats: 50, elevation: 55, depth: 0, covered: false }
    ],
    vertices: [
      { x: -15, y: 55, z: 390 },
      { x: 15, y: 55, z: 390 },
  ...
  // District Dugout
  {
    ...
    orientation: 'third-base',
    rows: [
      { rowNumber: 'Dugout', seats: 30, elevation: 3, depth: 0, covered: true }
    ],
    vertices: [
      { x: -80, y: 3, z: 15 },
      { x: -60, y: 3, z: 20 },
  ...
  // The Bullpen
  {
    ...
    orientation: 'right-field',
    rows: [
      { rowNumber: 'Picnic', seats: 80, elevation: 8, depth: 0, covered: false }
    ],
    vertices: [
      { x: 130, y: 8, z: 200 },
      { x: 150, y: 8, z: 220 },
  ...
  // Budweiser Terrace
  {
    ...
    accessibilityRating: 4,
    features: {
      budweiserTerrace: true,
      sections237to243: true,
  ...
  // Budweiser Brewhouse (formerly Red Porch)
  {
    ...
    orientation: 'center-field',
    rows: [
      { rowNumber: 'Bar', seats: 120, elevation: 25, depth: 0, covered: false },
      { rowNumber: 'Patio', seats: 80, elevation: 28, depth: 5, covered: false }
    ],
    vertices: [
      { x: -20, y: 25, z: 400 },
      { x: 20, y: 25, z: 400 },
