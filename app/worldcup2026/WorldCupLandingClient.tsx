            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <p className="text-sm text-blue-800 font-medium">
                  <strong>Time Zone Notice:</strong> All kickoff times are displayed in the venue&apos;s local timezone. The countdown shows time remaining until the match in your current timezone.
                </p>
              </div>
            </div>
          </div>
