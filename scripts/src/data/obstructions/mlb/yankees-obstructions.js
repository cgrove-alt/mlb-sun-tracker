...
exports.yankeeStadiumObstructionMap = exports.yankeeStadiumObstructions = void 0;
exports.calculateShadowCoverage = calculateShadowCoverage;
// Helper to create box mesh
function createBoxMesh(min, max) {
    const vertices = [
        // Bottom face
...
exports.yankeeStadiumObstructions = [
    // ========== UPPER DECK OVERHANG ==========
    {
        id: 'upper_deck_overhang_home',
        name: 'Upper Deck Overhang - Home Plate',
        type: 'overhang',
        geometry: createBoxMesh({ x: -60, y: 100, z: 60 }, { x: 60, y: 140, z: 65 }),
        boundingBox: {
            min: { x: -60, y: 100, z: 60 },
            max: { x: 60, y: 140, z: 65 }
        },
    ...
    },
    {
        ...
        type: 'overhang',
        geometry: createBoxMesh({ x: 60, y: 60, z: 60 }, { x: 140, y: 100, z: 65 }),
        boundingBox: {
            min: { x: 60, y: 60, z: 60 },
    ...
    },
    {
        ...
        type: 'overhang',
        geometry: createBoxMesh({ x: -140, y: 60, z: 60 }, { x: -60, y: 100, z: 65 }),
        boundingBox: {
            min: { x: -140, y: 60, z: 60 },
            max: { x: -60, y: 100, z: 65 }
        },
    ...
    // ========== GRANDSTAND ROOF ==========
    {
        ...
        type: 'roof',
        geometry: createBoxMesh({ x: -80, y: 180, z: 155 }, { x: 80, y: 230, z: 160 }),
        boundingBox: {
    ...
    // ========== MONUMENT PARK OVERHANG ==========
    {
        ...
        type: 'overhang',
        geometry: createBoxMesh({ x: -50, y: 380, z: 15 }, { x: 50, y: 410, z: 35 }),
        boundingBox: {
            min: { x: -50, y: 380, z: 15 },
            max: { x: 50, y: 410, z: 35 }
        },
    ...
    // ========== VIDEO BOARD (Center Field) ==========
    {
        ...
        type: 'scoreboard',
        geometry: createBoxMesh({ x: -30, y: 408, z: 20 }, { x: 30, y: 410, z: 60 }),
        boundingBox: {
            min: { x: -30, y: 408, z: 20 },
            max: { x: 30, y: 410, z: 60 }
        },
    ...
    // ========== SUITE LEVEL GLASS ==========
    {
        ...
        type: 'structure',
        geometry: createBoxMesh({ x: -100, y: 120, z: 65 }, { x: 100, y: 125, z: 85 }),
        boundingBox: {
    ...
    // ========== PRESS BOX ==========
    {
        ...
        name: 'Press Box',
        type: 'structure',
        geometry: createBoxMesh({ x: -40, y: 140, z: 85 }, { x: 40, y: 160, z: 95 }),
        boundingBox: {
            min: { x: -40, y: 140, z: 85 },
            max: { x: 40, y: 160, z: 95 }
        },
...
exports.yankeeStadiumObstructionMap = new Map(exports.yankeeStadiumObstructions.map(obs => [obs.id, obs]));
// Calculate total shadow area
function calculateShadowCoverage(obstructions, sunAzimuth, sunElevation) {
