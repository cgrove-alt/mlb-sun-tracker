...
"rome-braves": {
    ...
    "fayetteville-woodpeckers": {
        ...
        "notes": "Segra Stadium official 2026 seating map: bowl 108-128, suites S-1 through S-6, Copiers Plus Field Boxes, Mission Roll Call Club, Party Deck, Blanton's Picnic Zone, Landing Deck, Sergeant's Valor Bar, Miller Lite Landing, Berm/SRO, 4Topps Tables, Chick-fil-A Play Zone.",
        "bands": [
            {"ids": [str(n) for n in range(108, 129)], "level": "lower", "namePrefix": "Section"},
            {"ids": [f"S-{n}" for n in range(1, 7)], "level": "suite", "namePrefix": "Suite", "startOffset": 100, "endOffset": 260},
        ],
        "named": [
    ...
    "altoona-curve": {
        ...
        "notes": "PNG Field official seating chart: 100 Level 101-122 (Toyota Diamond Club 108-115), Terrace 201-216, Grandstand 301-316, Home Run Junction 502-503, plus Rail Kings, Budweiser Party Deck, Kunzler Grill, Reliance Bank Grass Seating, picnic pavilions, Weis 1B Bleachers, Shannon's Stuffy Style, Kids Zone, and Luxury Suites (suite numbers not labeled individually).",
        "bands": [
            {"ids": [str(n) for n in range(101, 123)], "level": "lower", "namePrefix": "Section"},
            {"ids": [str(n) for n in range(201, 217)], "level": "club", "namePrefix": "Terrace", "startOffset": 80, "endOffset": 280},
            {"ids": [str(n) for n in range(301, 317)], "level": "upper", "namePrefix": "Grandstand", "startOffset": 70, "endOffset": 290},
    ...
    "arkansas-travelers": {
        ...
        "notes": "Dickey-Stephens Park official stadium map: Home Plate Box 107-112, Field Box 104-106 and 113-118, Home Plate Reserved 207-212, Field Reserved 204-206 and 213-218, Luxury Suites 1-24, plus Trex Berm, Hook Slide Corner Beer Garden, Beer Garden Bleachers, Otey's Splash Pad, and map-key hospitality (Pinnacle/Tracks pavilions, Baggage/Club Car picnic, Dickey Room, Acura Party Deck). Gate/office callouts omitted.",
        "bands": [
            {"ids": [str(n) for n in range(104, 119)], "level": "lower", "namePrefix": "Section"},
            {"ids": [str(n) for n in range(204, 219)], "level": "club", "namePrefix": "Section", "startOffset": 80, "endOffset": 280},
            {"ids": [str(n) for n in range(1, 25)], "level": "suite", "namePrefix": "Suite", "startOffset": 60, "endOffset": 300},
        ],
        "named": [
    ...
    "scranton-railriders": {
        ...
        "notes": "PNC Field official seating chart: bowl/outer ring 1-32 (shared numbers across walkway tiers are not duplicated), Geisinger Champions Club & Suite Level 200-205, plus Homer Zone Lawn, KOST Pavilion, AZEK Party Decks, Bleachers, Railhouse, Unibet Grove. Birthday Cave / Mama T's / Kids Zone are amenities, not separate inventory products.",
        "bands": [
            {"ids": [str(n) for n in range(1, 33)], "level": "lower", "namePrefix": "Section"},
            {"ids": [str(n) for n in range(200, 206)], "level": "suite", "namePrefix": "Suite", "startOffset": 140, "endOffset": 220},
        ],
        "named": [
    ...
    "everett-aquasox": {
        ...
        "notes": "Funko Field official seating chart: lettered grandstand A-M (upper/lower share letters; listed once), baseline bleachers 1-8, Kelley Create Press Box Suite, PAE Home Run Porch, Pepsi Picnic Pavilion, Miller Lite Great Taste Bullpen BBQ, Fun Zone.",
        "bands": [
            {"ids": [chr(c) for c in range(ord("A"), ord("M") + 1)], "level": "lower", "namePrefix": "Section"},
            {"ids": [str(n) for n in range(1, 9)], "level": "field", "namePrefix": "Section", "startOffset": 250, "endOffset": 110},
        ],
        "named": [
    ...
    "bradenton-marauders": {
        ...
        "notes": "LECOM Park official seating chart: sections 1-23 and 25 (no 24; inner/outer walkway tiers share numbers and are listed once), plus Private Box, LaPensee Party Deck, Left Field Patio, Boardwalk BBQ Area, Kona Big Wave Bar, Michelob Ultra Plaza Bar, Fan Plaza.",
        "bands": [
            {"ids": [str(n) for n in list(range(1, 24)) + [25]], "level": "lower", "namePrefix": "Section"},
        ],
        "named": [
    ...
    "clearwater-threshers": {
        ...
        "notes": "BayCare Ballpark official seating chart: 100 Level 101-120, RF pavilion P1-P3, upper 201-212, Berm, Tiki Terrace, Tiki Pavilion.",
        "bands": [
            {"ids": [str(n) for n in range(101, 121)], "level": "lower", "namePrefix": "Section"},
            {"ids": ["P1", "P2", "P3"], "level": "field", "namePrefix": "Section", "startOffset": 30, "endOffset": 70},
            {"ids": [str(n) for n in range(201, 213)], "level": "upper", "namePrefix": "Section", "startOffset": 120, "endOffset": 240},
        ],
        "named": [
    ...
    "st-lucie-mets": {
        ...
        "notes": "Clover Park official PSL stadium map: lower bowl 1-22, covered upper 104-116, Premium Box (rows within 8-12), Party Deck, The Hill, Field Level Terrace. Row-tier ticket products are not separate section IDs.",
        "bands": [
            {"ids": [str(n) for n in range(1, 23)], "level": "lower", "namePrefix": "Section"},
            {"ids": [str(n) for n in range(104, 117)], "level": "upper", "namePrefix": "Section", "startOffset": 100, "endOffset": 260},
        ],
        "named": [
    ...
    "amarillo-sod-poodles": {
        ...
        "notes": "Hodgetown official stadium map: bowl 103-119 (Zone C rail numbers share 104-118 and are listed once), Left/Right Field Patio, Right Field Berm, Coterie hospitality, The Ruckus Kid's Corral.",
        "bands": [
            {"ids": [str(n) for n in range(103, 120)], "level": "lower", "namePrefix": "Section"},
        ],
        "named": [
    ...
    "biloxi-shuckers": {
        ...
        "notes": "Keesler Federal Park / MGM Park official stadium map: bowl 100-117 and 119 (no 118 labeled), suites 1-12, Kloud 7 Yacht Club, Renova Rooftop, Left Field Terrace, Party Deck, beer gardens, Corona Premier Tiki Bar, Schooner's Splash Zone, Sand Bar.",
        "bands": [
            {"ids": [str(n) for n in list(range(100, 118)) + [119]], "level": "lower", "namePrefix": "Section"},
            {"ids": [str(n) for n in range(1, 13)], "level": "suite", "namePrefix": "Suite", "startOffset": 80, "endOffset": 280},
        ],
        "named": [
    ...
    "rancho-cucamonga-quakes": {
        ...
        "notes": "LoanMart Field official 2026 seating chart: unique section numbers 1-17 across Club/Superbox/upper/lower/dugout/field-box tiers (shared numbers listed once), Onward Suites as a named band (suite numerals collide with section 1), Strike Zone Tables, LF Cafe, Pavilion, Batting Cage Terrace, Fault Zone, Michelob Ultra Plaza, Dave & Buster's Fun Zone.",
        "bands": [
            {"ids": [str(n) for n in range(1, 18)], "level": "lower", "namePrefix": "Section"},
        ],
        "named": [
    ...
    "hillsboro-hops": {
        ...
        "notes": "Ron Tonkin Field official season-ticket pricing map: 100 Level 101-122, upper boxes 201-209, Budweiser Terrace, The Lookout, Barrel District, Argyle, Hop Grove, General Admission berms.",
        "bands": [
            {"ids": [str(n) for n in range(101, 123)], "level": "lower", "namePrefix": "Section"},
            {"ids": [str(n) for n in range(201, 210)], "level": "club", "namePrefix": "Section", "startOffset": 100, "endOffset": 260},
        ],
        "named": [
    ...
    "lynchburg-hillcats": {
        ...
        "notes": "City Stadium (Hill City Howlers) official seating map: Reserved 1-11, Skybox Level A-N, VIP Seating, Bleachers, Dunes, 1st Base Party Deck, 3rd Base Bar, Loge Boxes, Clubhouse GA.",
        "bands": [
            {"ids": [str(n) for n in range(1, 12)], "level": "lower", "namePrefix": "Reserved"},
            {"ids": [chr(c) for c in range(ord("A"), ord("N") + 1)], "level": "suite", "namePrefix": "Skybox", "startOffset": 80, "endOffset": 280},
        ],
        "named": [
    ...
    "aberdeen-ironbirds": {
        ...
        "notes": "Ripken Stadium official seating map: field 100-126, middle 201-209 odds / 202-208 and 210/212 evens, Bird's Nest 2001-2003, Club Level 1-14 (14 hosts High A Bar), Pavilion 301, Party Decks 302/304/306/308, Lower Picnic.",
        "bands": [
            {"ids": [str(n) for n in range(100, 127)], "level": "lower", "namePrefix": "Section"},
            {"ids": [str(n) for n in list(range(201, 210, 2)) + list(range(202, 209, 2)) + [210, 212]], "level": "club", "namePrefix": "Section", "startOffset": 80, "endOffset": 280},
            {"ids": ["2001", "2002", "2003"], "level": "suite", "namePrefix": "Bird's Nest", "startOffset": 160, "endOffset": 200},
            {"ids": [str(n) for n in range(1, 15)], "level": "club", "namePrefix": "Club", "startOffset": 70, "endOffset": 290},
    ...
    "cedar-rapids-kernels": {
        ...
        "notes": "Veterans Memorial Stadium official map: numbered bowl 100-118, McGrath Auto Party Plaza, Plumbers & Pipefitters Pavilion, The Lounge. Unnumbered green/purple group pads are not invented as section IDs.",
        "bands": [
            {"ids": [str(n) for n in range(100, 119)], "level": "lower", "namePrefix": "Section"},
        ],
        "named": [
    ...
    "stockton-ports": {
        ...
        "notes": "Banner Island Ballpark official stadium map: Field/MVP/Home Plate/Dugout products across 100-121, Scout Seats A/AA/AAA, Premier Staffing Club 214-216, 4Topps within 111/114/115, Fan Cave 121, Home Run Hill, Back Porch, Bullpen BBQ, Suites, Club Seats.",
        "bands": [
            {"ids": [str(n) for n in range(100, 122)], "level": "lower", "namePrefix": "Section"},
    ...
    "kannapolis-cannon-ballers": {
        ...
        "notes": "Atrium Health Ballpark season-ticket map overlay: bowl 101-115, upper boxes 201-204. Unlabeled picnic/terrace pads beyond 115 are not invented.",
        "inventoryStatus": "partial",
        "bands": [
            {"ids": [str(n) for n in range(101, 116)], "level": "lower", "namePrefix": "Section"},
            {"ids": [str(n) for n in range(201, 205)], "level": "suite", "namePrefix": "Section", "startOffset": 220, "endOffset": 280},
        ],
        "named": [],
    },
    "san-jose-giants": {
        ...
        "notes": "Excite Ballpark official seating chart: lettered bowl A-G (box/reserved share letters; listed once), Elcor Electric Party Patio, Right-Field Picnic Tables, NECA VIP Deck, Turkey Mike's BBQ, Beverage Deck, BBSI Futures Club.",
        "bands": [
            {"ids": [chr(c) for c in range(ord("A"), ord("G") + 1)], "level": "lower", "namePrefix": "Section"},
        ],
        "named": [
    ...
    "peoria-chiefs": {
        ...
        "notes": "Dozer Park official stadium chart: inner 101-114, outer reserved/field 2-18, Stratus Club and named suites/decks, berms, Home Run Landing, Party Patio, Hot Corner Club, Kids Zone.",
        "bands": [
            {"ids": [str(n) for n in range(101, 115)], "level": "lower", "namePrefix": "Section"},
            {"ids": [str(n) for n in range(2, 19)], "level": "upper", "namePrefix": "Section", "startOffset": 60, "endOffset": 300},
        ],
        "named": [
    ...
    "delmarva-shorebirds": {
        ...
        "notes": "Arthur W. Perdue Stadium official 3D illustration: lower 101-120, middle 201-214, upper odds 301/303/305/307, Executive Club boxes 1-6, Hardball Cafe, Picnic Deck, 3B Party Deck, LF/RF Outfield Decks, 1B/3B Drink Rails.",
        "bands": [
            {"ids": [str(n) for n in range(101, 121)], "level": "lower", "namePrefix": "Section"},
            {"ids": [str(n) for n in range(201, 215)], "level": "club", "namePrefix": "Section", "startOffset": 80, "endOffset": 280},
            {"ids": ["301", "303", "305", "307"], "level": "upper", "namePrefix": "Section", "startOffset": 200, "endOffset": 280},
            {"ids": [str(n) for n in range(1, 7)], "level": "suite", "namePrefix": "Box", "startOffset": 100, "endOffset": 260},
        ],
        "named": [
    ...
    "knoxville-smokies": {
        ...
        "notes": "Covenant Health Park official 2025 stadium map: bowl 101-121, ORNL Luxury Level Club, Dugout Suites, 4-Topps, TVA 1B Concourse Suites, Pipe Wrench 3B Concourse Suites, ORNL Porch, Garza Law 1st Base Porch, Pioneer K-Jay Corner, Bush's Beans Picnic Pavilion, Modelo Watering Hole, Chick-fil-A Kid's Zone.",
        "bands": [
            {"ids": [str(n) for n in range(101, 122)], "level": "lower", "namePrefix": "Section"},
        ],
        "named": [
    ...
    "rochester-red-wings": {
        ...
        "notes": "Innovative Field official groups seating chart: 100 Level 101-130, 200 Level odd 201-229, plus Single-Game Suites, High Falls Lounge, Ford Hardball Cafe, Club 3000 / The Nest, MLB Club, Silver Stadium Club, Sensory Suite, ESL Left Field Terrace, Foul Pole Patio, The Porch, Re/Max Nest Pavilion, Hot Corner and Walk of Fame group areas. Even 200s are not labeled on the chart.",
        "bands": [
            {"ids": [str(n) for n in range(101, 131)], "level": "lower", "namePrefix": "Section"},
            {"ids": [str(n) for n in range(201, 230, 2)], "level": "upper", "namePrefix": "Section", "startOffset": 70, "endOffset": 290},
        ],
        "named": [
    ...
    "lansing-lugnuts": {
        ...
        "notes": "Jackson Field official group pricing map: lettered bowl A-H and J-N and P-Q (I and O omitted), bleachers AA-DD, Lawn, Nightly Suites, The Clubhouse, Pepsi Porch, Worklist Deck, MSU Health Care Terrace, The View / Good Hops, Big Lug's Playground, Airport Lounge. Row-tier colors are not separate section IDs.",
        "bands": [
            {"ids": [chr(c) for c in range(ord("A"), ord("H") + 1)] + [chr(c) for c in range(ord("J"), ord("N") + 1)] + ["P", "Q"], "level": "lower", "namePrefix": "Section"},
    ...
    "tulsa-drillers": {
        ...
        "notes": "ONEOK Field official stadium map: bowl 101-119, John Zink Club A-H and J (no I), Delta Dental Suites 1-23, Cadillac Club, Trident Loge Box, Metro Field Level Suite, Ferguson Kia Lawn, splash/kids zones, Country Financial Terrace, Scoreboard Bar, Osage Pavilion, Busch Light Landing, Hop & Sting, Discount Tire Backyard, QuikTrip Hornsby's Hangout, Norlem Event Center, Coors Light Refinery Deck, Riverspirit Party Platforms.",
        "bands": [
            {"ids": [str(n) for n in range(101, 120)], "level": "lower", "namePrefix": "Section"},
            {"ids": [chr(c) for c in range(ord("A"), ord("H") + 1)] + ["J"], "level": "club", "namePrefix": "John Zink Club", "startOffset": 150, "endOffset": 210},
            {"ids": [str(n) for n in range(1, 24)], "level": "suite", "namePrefix": "Suite", "startOffset": 70, "endOffset": 290},
        ],
        "named": [
    ...
    "wichita-wind-surge": {
        ...
        "notes": "Equity Bank Park / Riverfront official seating map: bowl 1-21, The Vault, Coors Light Party Porch, Right Field Picnic Pavilion, Boot Barn Home Run Deck, Outfield Oasis, Pumphouse, Emprise Bank Pavilion.",
        "bands": [
            {"ids": [str(n) for n in range(1, 22)], "level": "lower", "namePrefix": "Section"},
        ],
        "named": [
    ...
    "palm-beach-cardinals": {
        ...
        "notes": "Roger Dean Chevrolet Stadium official 2026 seat map (shared Jupiter / Palm Beach bowl): 101 Club + Field/Home Plate Box 101-122, Reserved/Value 201-213, Luxury Suites 1-6, JMC Champions Club, Hot Corner, Cassidy Cool Zone, First Base Party Tent.",
        "bands": [
            {"ids": [str(n) for n in range(101, 123)], "level": "lower", "namePrefix": "Section"},
            {"ids": [str(n) for n in range(201, 214)], "level": "upper", "namePrefix": "Section", "startOffset": 80, "endOffset": 280},
            {"ids": [str(n) for n in range(1, 7)], "level": "suite", "namePrefix": "Suite", "startOffset": 120, "endOffset": 180},
        ],
        "named": [
    ...
    "modesto-nuts": {
        ...
        "notes": "ONT Field (Ontario Tower Buzzers) official club seating map: bowl 102-123 (no 101 labeled), RF blocks 124-132, Home Plate Box 201-206, Suites 1-12. Uncertain 133-135 lawn callouts are not invented.",
        "bands": [
            {"ids": [str(n) for n in range(102, 133)], "level": "lower", "namePrefix": "Section"},
            {"ids": [str(n) for n in range(201, 207)], "level": "club", "namePrefix": "Section", "startOffset": 150, "endOffset": 210},
            {"ids": [str(n) for n in range(1, 13)], "level": "suite", "namePrefix": "Suite", "startOffset": 200, "endOffset": 280},
        ],
        "named": [],
    },
    "san-antonio-missions": {
        ...
        "notes": "Nelson W. Wolff Stadium official seating chart: lower 100-124 and 126 (no 125), upper 200-210, Suite Level, Party Patio, Party Pavilion, Party Deck, Fun Zone, Berm Seating.",
        "bands": [
            {"ids": [str(n) for n in list(range(100, 125)) + [126]], "level": "lower", "namePrefix": "Section"},
            {"ids": [str(n) for n in range(200, 211)], "level": "upper", "namePrefix": "Section", "startOffset": 80, "endOffset": 280},
        ],
        "named": [
    ...
    "augusta-greenjackets": {
        ...
        "notes": "SRP Park official seating chart: 100 plus 1B odds 101/103/105/107/109 and 3B evens 102/104/106/108/110/112 (no 111), upper 200-206, Suites 1-10.",
        "bands": [
            {"ids": ["100"] + [str(n) for n in range(101, 111, 2)] + [str(n) for n in range(102, 113, 2)], "level": "lower", "namePrefix": "Section"},
            {"ids": [str(n) for n in range(200, 207)], "level": "upper", "namePrefix": "Section", "startOffset": 100, "endOffset": 260},
            {"ids": [str(n) for n in range(1, 11)], "level": "suite", "namePrefix": "Suite", "startOffset": 80, "endOffset": 280},
        ],
        "named": [],
    },
    "lake-county-captains": {
        ...
        "notes": "Classic Auto Group Park official stadium map: 100 Level 101-120, Suite Level 203-208 and 214-221 (209-213 behind home are Press Box / Pirate Suite, not invented as bowl IDs), plus party decks, loft, cove, picnic plazas, Blanket Berm, Pirate Bar, Captains Cafe, 50s Diner Row, Swinger's Paradise.",
        "bands": [
            {"ids": [str(n) for n in range(101, 121)], "level": "lower", "namePrefix": "Section"},
            {"ids": [str(n) for n in list(range(203, 209)) + list(range(214, 222))], "level": "suite", "namePrefix": "Section", "startOffset": 70, "endOffset": 290},
        ],
        "named": [
    ...
    "wilmington-blue-rocks": {
        ...
        "notes": "Frawley Stadium official 2026 seating chart: Field Box 1-28, Upper Box A-P, outer 301-308 and 310-317 (no 309), Chase Picnic Deck, Highmark GA, Dogfish Head Off-Centered Fan Deck, Chickie's & Pete's, Stalvey's Pub, Bluewinkle's Diamond Club.",
        "bands": [
            {"ids": [str(n) for n in range(1, 29)], "level": "field", "namePrefix": "Section"},
            {"ids": [chr(c) for c in range(ord("A"), ord("P") + 1)], "level": "lower", "namePrefix": "Upper Box"},
            {"ids": [str(n) for n in list(range(301, 309)) + list(range(310, 318))], "level": "upper", "namePrefix": "Section", "startOffset": 80, "endOffset": 280},
        ],
        "named": [
    ...
    "daytona-tortugas": {
        ...
        "notes": "Jackie Robinson Ballpark official seating chart: VIP 1-13, Reserved A-C, plus General Admission, Stroud's Turtles Nest, Cold Stone Patio, Yuengling Flight Deck, PMR Daytona Beach Club, Party Pavilion.",
        "bands": [
            {"ids": [str(n) for n in range(1, 14)], "level": "field", "namePrefix": "VIP"},
    ...
    "chattanooga-lookouts": {
        ...
        "notes": "Erlanger Park official stadium map: 100 Level 101-116, 200 Level 201-207, 300 Level 301-309, Field Boxes, Little Debbie Berm, Kubota Club, HHM Party Deck, Right Field Perch, Rock City Bar & Cabanas, Kid's Zone. Suite numbers inside Suite Club are not labeled individually.",
        "bands": [
            {"ids": [str(n) for n in range(101, 117)], "level": "lower", "namePrefix": "Section"},
            {"ids": [str(n) for n in range(201, 208)], "level": "club", "namePrefix": "Section", "startOffset": 140, "endOffset": 240},
            {"ids": [str(n) for n in range(301, 310)], "level": "upper", "namePrefix": "Section", "startOffset": 130, "endOffset": 250},
        ],
        "named": [
    ...
    "binghamton-rumble-ponies": {
        ...
        "notes": "Mirabito Stadium official 2026 seating chart: field 1-14, 16, 18 (no 15/17), upper 100-114, MTS Suite Level (suite numbers not labeled). Terrace Box is a row product within the field band.",
        "bands": [
            {"ids": [str(n) for n in list(range(1, 15)) + [16, 18]], "level": "field", "namePrefix": "Section"},
            {"ids": [str(n) for n in range(100, 115)], "level": "upper", "namePrefix": "Section", "startOffset": 70, "endOffset": 290},
        ],
        "named": [
    ...
    "south-bend-cubs": {
        ...
        "notes": "Four Winds Field official 2026 stadium map: Field/Dugout 101-118, Home Run Porch 119-124, concourse suites 1-10, premium 207-208, plus named decks, lawns, splash pad, rooftop, and 11/11 Club.",
        "bands": [
            {"ids": [str(n) for n in range(101, 125)], "level": "lower", "namePrefix": "Section"},
            {"ids": [str(n) for n in range(1, 11)], "level": "suite", "namePrefix": "Suite", "startOffset": 60, "endOffset": 300},
    ...
    "spokane-indians": {
        ...
        "notes": "Avista Stadium official 2025 printable map: Lower Box LB1-LB5, hospitality 1-22, reserved/box 100-103 and 120-122 (no invented 104-119), upper 200-222, plus named Clubhouse, Champions Club, cabins/porch/pub products.",
        "bands": [
            {"ids": [f"LB{n}" for n in range(1, 6)], "level": "field", "namePrefix": "Lower Box"},
            {"ids": [str(n) for n in range(1, 23)], "level": "club", "namePrefix": "Hospitality", "startOffset": 70, "endOffset": 310},
            {"ids": [str(n) for n in list(range(100, 104)) + list(range(120, 123))], "level": "lower", "namePrefix": "Section"},
            {"ids": [str(n) for n in range(200, 223)], "level": "upper", "namePrefix": "Section", "startOffset": 70, "endOffset": 300},
        ],
        "named": [
    ...
    "eugene-emeralds": {
        ...
        "notes": "PK Park official seating map: standard bowl 1-13 (premium/ADA are row products within those IDs, not new numbers), Summit Bank Suite Level (suite numerals unlabeled), Bleacher Seating, first-base and third-base Picnic Areas, Beatbox.",
        "bands": [
            {"ids": [str(n) for n in range(1, 14)], "level": "lower", "namePrefix": "Section"},
        ],
        "named": [
    ...
    "el-paso-chihuahuas": {
        ...
        "notes": "Southwest University Park official venue map: concourse 101-123, upper 201-216, Club Level Suites 1-10, Press Level Suites 11-24, plus named club/deck/porch/lawn products. Third-party maps are not used.",
        "bands": [
            {"ids": [str(n) for n in range(101, 124)], "level": "lower", "namePrefix": "Section"},
            {"ids": [str(n) for n in range(201, 217)], "level": "upper", "namePrefix": "Section", "startOffset": 80, "endOffset": 280},
            {"ids": [str(n) for n in range(1, 11)], "level": "suite", "namePrefix": "Club Suite", "startOffset": 90, "endOffset": 270},
            {"ids": [str(n) for n in range(11, 25)], "level": "suite", "namePrefix": "Press Suite", "startOffset": 80, "endOffset": 280},
        ],
        "named": [
    ...
    "reno-aces": {
        ...
        "notes": "Greater Nevada Field official seating map: bowl 101-120 (premium/reserved are price bands within those IDs), nvision Glass Suite Level unlabeled by suite number, plus named club/deck/berm products. Schedule assets are not treated as charts.",
        "bands": [
            {"ids": [str(n) for n in range(101, 121)], "level": "lower", "namePrefix": "Section"},
        ],
        "named": [
    ...
    "tri-city-dust-devils": {
        ...
        "notes": "Gesa Stadium official 3D seating map: field letters A-T, upper 101-108, General Admission, Dusty's Deck, EquipmentShare Bullpen, AutoZone Hot Corner. Suite boxes above 105-108 are unlabeled.",
        "bands": [
            {"ids": [chr(c) for c in range(ord("A"), ord("T") + 1)], "level": "field", "namePrefix": "Section"},
            {"ids": [str(n) for n in range(101, 109)], "level": "upper", "namePrefix": "Section", "startOffset": 100, "endOffset": 260},
        ],
        "named": [
    ...
    "dunedin-blue-jays": {
        ...
        "notes": "TD Ballpark official seating map: lower 100-112 (113-116 printed but marked unavailable and omitted), upper 200-206, 207L, 207R, 208-212, plus Pavilion, Orange Trail, WestJet Flight Deck, Right Field Social, and unlabeled suite blocks.",
        "bands": [
            {"ids": [str(n) for n in range(100, 113)], "level": "lower", "namePrefix": "Section"},
            {"ids": [str(n) for n in list(range(200, 207)) + ["207L", "207R"] + [str(n) for n in range(208, 213)]], "level": "upper", "namePrefix": "Section", "startOffset": 90, "endOffset": 270},
        ],
        "named": [
    ...
    "west-michigan-whitecaps": {
        ...
        "notes": "LMCU Ballpark official 2026 beer-rollout stadium map: bowl 109-125 only (101-108 are not labeled and are not invented), plus DTE Suite Level, 1B/3B Terraces, Rooftop, Leinie Lodge, Founders Cap Room, Mitten Craft Clubhouse, Pepsi Stadium Club / Miller Lite House Deck.",
        "bands": [
            {"ids": [str(n) for n in range(109, 126)], "level": "lower", "namePrefix": "Section"},
        ],
        "named": [
    ...
    "carolina-mudcats": {
        ...
        "notes": "Wilson Ballpark official 2026 seating chart (franchise id carolina-mudcats; 2026 home is Wilson Warbirds). Home Plate Club 001-002, Dugout/Home Plate Reserved 102-117, Terrace 118, Luxury Suites 1-8, plus Hubert Vester Auto Group Grass Berm, Captain's Club, PEPSI Flight Deck, Poba Party Patio, and Altitude Bar. Section 101 is not labeled.",
        "bands": [
            {"ids": ["001", "002"], "level": "club", "namePrefix": "Home Plate Club"},
            {"ids": [str(n) for n in range(102, 119)], "level": "lower", "namePrefix": "Section"},
            {"ids": [str(n) for n in range(1, 9)], "level": "suite", "namePrefix": "Luxury Suite", "startOffset": 140, "endOffset": 200},
        ],
        "named": [
    ...
    "down-east-wood-ducks": {
        ...
        "notes": "Fifth Third Park official seating chart on the Hub City tickets page (franchise id down-east-wood-ducks). Bowl 101-120, Milliken Club 201-204, Drink Rails 205-210, Suites 211-216, Bo Boxes 1-8, plus SCC Berm, Chasers Corner, Dr. Pepper Terrace, Patio, and AFL Dugout Lounge. A smaller 16:9 marketing crop is not used as the inventory source.",
        "bands": [
            {"ids": [str(n) for n in range(101, 121)], "level": "lower", "namePrefix": "Section"},
            {"ids": [str(n) for n in range(201, 205)], "level": "club", "namePrefix": "Milliken Club", "startOffset": 70, "endOffset": 110},
            {"ids": [str(n) for n in range(205, 211)], "level": "club", "namePrefix": "Drink Rail", "startOffset": 150, "endOffset": 210},
            {"ids": [str(n) for n in range(211, 217)], "level": "suite", "namePrefix": "Suite", "startOffset": 220, "endOffset": 280},
            {"ids": [str(n) for n in range(1, 9)], "level": "club", "namePrefix": "Bo Box", "startOffset": 160, "endOffset": 200},
        ],
        "named": [
    ...
    "bowie-baysox": {
        ...
        "notes": "Prince George's Stadium official M-NCPPC seating map on the Chesapeake Baysox ticket-information page: Box 101-124 (1B odds / 3B evens), Reserve 201-208, plus General Admission, hospitality rooms/decks, Owner's Suite, Skyboxes 1-5, Diamond View Restaurant, and Luminis Health Birthday Tent. Press box and training-facility labels are not ticket products.",
        "bands": [
            {"ids": [str(n) for n in range(101, 125)], "level": "lower", "namePrefix": "Box"},
            {"ids": [str(n) for n in range(201, 209)], "level": "upper", "namePrefix": "Reserve", "startOffset": 140, "endOffset": 220},
        ],
        "named": [
