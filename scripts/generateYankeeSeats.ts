...
// Fine-tune adjustments to hit exact capacity (46,537 seats)
...
const FINE_TUNE_ADJUSTMENTS: Record<string, Record<string, number>> = {
  // Remove 1 seat from rows 20-22 for Field Level sections (3 rows × 34 sections = 102 seats)
  '103': { '20': -1, '21': -1, '22': -1 },
  '104': { '20': -1, '21': -1, '22': -1 },
  '105': { '20': -1, '21': -1, '22': -1 },
  '106': { '20': -1, '21': -1, '22': -1 },
  ...
  '135': { '20': -1, '21': -1, '22': -1 },
  '136': { '20': -1, '21': -1, '22': -1 },
  // Remove 1 seat from row 19-21 for Main Level sections (3 rows × 37 sections - but only 20 = 60 seats)
  '202': { '19': -1, '20': -1, '21': -1 },
  '203': { '19': -1, '20': -1, '21': -1 },
  '204': { '19': -1, '20': -1, '21': -1 },
  '205': { '19': -1, '20': -1, '21': -1 },
...
// Total removed: 102 (Field) + 61 (Main) = 163 seats
